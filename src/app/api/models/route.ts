...
const KIE_MODELS: ProviderModel[] = [
  ...
  },
  {
    ...
    description: "Image editing by Seedream 5.0 Lite with multimodal reasoning support.",
    provider: "kie",
    capabilities: ["image-to-image"],
    coverImage: undefined,
    pageUrl: "https://docs.kie.ai/market/seedream/5-lite-image-to-image",
  },
  {
    id: "nano-banana-2",
    name: "Nano Banana 2",
    description: "Google Nano Banana 2 via Kie.ai. Supports text-to-image and image-to-image generation.",
    provider: "kie",
